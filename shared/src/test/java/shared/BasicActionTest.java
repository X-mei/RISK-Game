...
public class BasicActionTest {
  ...
  public void test_getActionOwner() {
    ...
    BasicAction a = f.createMove("player1", "A B 2 Lv1");
    assertEquals("player1", a.getActionOwner());
    BasicAction a1 = f.createAttack("player2", "C D 4 Lv10");
  ...
  public void test_getActionName() {
    ...
    BasicAction a1 = f.createAttack("player2", "C D 4 Lv4");
  ...
  public void test_getSrcDest() {
    ...
    BasicAction a1 = f.createMove("player1", "start end 10 Lv1");
    ...
    assertThrows(IllegalArgumentException.class, () -> f.createMove("player1", "start end 10s exit"));
