...
public class OwnerCheckerTest {
  ...
  public void test_OwnerRule() throws IOException {
    ...
    BasicAction b2 = new Move("King", "Hanamura B 10");
    BasicAction b4 = new Attack("King", "Ilios B 10");
    BasicAction b3 = new Attack("Red", "Ilios B 10");
    BasicAction b5 = new Attack("Red", "A B 10");
