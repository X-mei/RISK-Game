...
public class UpgradeCheckerTest {
  ...
  public void test_UpgradeAction() {
    ...
    b.singleTerritoryUnitSetup("Dorado", new int[]{5, 0, 0, 0, 0, 0, 0}); 
    b.singleTerritoryUnitSetup("Hanamura", new int[]{3, 10, 0, 0, 0, 0, 0 });
    b.singleTerritoryUnitSetup("Hollywood", new int[] {0, 0, 5, 0, 0, 0,  0});
    b.singleTerritoryUnitSetup("Volskaya", new int[]{1, 0, 0, 5, 0, 0,  0});
    b.singleTerritoryUnitSetup("Ilios", new int[]{0, 0 ,  0, 0, 10, 0, 0}); 
    b.singleTerritoryUnitSetup("Junkertown", new int[]{5, 0, 0, 0, 0, 0, 5});
    ...
    assertEquals("The selected source do not exist.", c.checkAction(a5, b));
